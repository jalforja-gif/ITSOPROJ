  ...
  <div class="modal-content modal-lg">
    ...
    <div class="modal-body">
      <form method="POST" action="update_status.php">
        <input type="hidden" name="ip_id" id="modal_ip_id_ongoing">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" name="new_status" value="For Revision" class="disapprove-btns">For Revision</button>
        </div>
      </form>
    </div>
  </div>
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  reviewButtons.forEach(button => {
    button.addEventListener('click', () => {
      // set id field for ongoing review modal
      document.getElementById('modal_ip_id_ongoing').value = button.dataset.id;
