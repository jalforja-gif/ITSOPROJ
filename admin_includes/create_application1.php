...
<div id="step-1" class="space-y-4 w-full"> 
      ...
      <div>
  <label class="block text-sm md:text-base font-medium mb-1">Abstract / Description *</label>
  <textarea name="abstract" rows="4" class="w-full border rounded px-3 py-2" placeholder="Write a brief description of your IP" required></textarea>
</div>
  ...
  <div id="step-2" class="space-y-4 hidden">
    ...
    <div id="step-4" class="space-y-4 hidden">
      ...
      <label class="block text-sm md:text-base font-medium mb-1">Application Form <i>(*pdf only)</i></label>
      <input type="file" name="application_form" accept=".pdf" class="w-full border rounded px-3 py-2" required>
      <label class="block text-sm md:text-base font-medium mb-1">Project File <i>(*zip file only)</i></label>
      <input type="file" name="project_file" accept=".zip" class="w-full border rounded px-3 py-2" required>
      <label class="block text-sm md:text-base font-medium mb-1">Endorsement Letter <i>(*pdf only)</i></label>
      ...
      <label class="block text-sm md:text-base font-medium mb-1">Issued Certificate <p class="text-grat-500 text-xs md:text-sm"><i>*certificate from ipophil, if already issued (optional)</i></label>
